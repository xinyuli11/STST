...
#' @title A illustration dataset
#' @name irisl
#' @description A dataset used to illustrate the performance of Gradient Descent.
#' @examples
#' \dontrun{
#' data(irisl)
...
#' @param x X is the data matrix
#' @param y Y  is measurements
#' @param error Error termination condition
#' @param maxiter Maximum number of iterations for Maxiter
#' @param stepmethod The default is Backward descent method
#' @param step  Step is the fixed step size set
#' @param alpha It is a parameter of the backward descent method
#' @param beta It is a parameter of the backward descent method
#' @return Coefficient,iteration number,error 
#' @examples
#' \dontrun{
#' data("iris")
#' x<-matrix(iris[1:50,1],50,1)
...
#' }
#' @export
GradientDescent<-function(x,y,error,maxiter,stepmethod,step,alpha,beta)
{
  m<-nrow(x)
